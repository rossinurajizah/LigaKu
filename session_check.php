...
// Cek: Jika mengakses input_pemain.php tapi belum daftar tim sementara
if ($currentFile === 'input_pemain.php') {
    // Cek apakah NAMA TIM sementara sudah disimpan di sesi
    if (empty($_SESSION['temp_team_name'])) { 
        echo "<script>
